...
-- CreateTable
CREATE TABLE "DefalutItemList" (
    "id" SERIAL NOT NULL,
    "itemName" TEXT NOT NULL,
    "itemDescription" TEXT NOT NULL,
    "itemIcon" TEXT,

    CONSTRAINT "DefalutItemList_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "PlayerItem" ADD CONSTRAINT "PlayerItem_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "DefalutItemList"("id") ON DELETE CASCADE ON UPDATE CASCADE;
